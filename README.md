...
아래 영상은 실제 에이전트 채팅과 한/글 문서 편집 과정을 담은 **무편집 원본 화면 녹화**입니다. 썸네일이나 `원본 MP4 열기`를 누르면 전체 영상을 볼 수 있습니다.

| 기존 내용 바꾸기 (1분 7초) | 문서 내용 채우기 (1분 47초) |
|---|---|
| [![기존 내용 바꾸기 시연](docs/media/내용바꾸기.jpg)](docs/media/내용바꾸기.mp4) | [![문서 내용 채우기 시연](docs/media/내용채우기.jpg)](docs/media/내용채우기.mp4) |
| 기존 내용을 검토하고 변경안을 적용하는 과정<br>[원본 MP4 열기](docs/media/내용바꾸기.mp4) | 문서 구조를 확인한 뒤 비어 있는 내용을 채우는 과정<br>[원본 MP4 열기](docs/media/내용채우기.mp4) |

| 이미지로 표 만들기 (4분 56초) | 표 내용·사진 채우기 (1분 4초) |
|---|---|
| [![이미지로 표 만들기 시연](docs/media/이미지로표만들기.jpg)](docs/media/이미지로표만들기.mp4) | [![표 내용과 사진 채우기 시연](docs/media/표내용,사진채우기.jpg)](docs/media/표내용,사진채우기.mp4) |
| 이미지 자료를 바탕으로 한/글 표를 구성하는 과정<br>[원본 MP4 열기](docs/media/이미지로표만들기.mp4) | 표의 내용과 관련 사진을 함께 채우는 과정<br>[원본 MP4 열기](docs/media/표내용,사진채우기.mp4) |
