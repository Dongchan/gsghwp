...
try {
    ...
    $install = Install-GsgHwpNative -Paths $fixture.Paths -PackageVersion "1.0.3" `
...
try {
    $null = Install-GsgHwpNative -Paths $cleanFixture.Paths -PackageVersion "1.0.3" `
...
try {
    ...
    $null = Install-GsgHwpNative -Paths $upgradeFixture.Paths -PackageVersion "1.0.3" `
